...
ALTER TABLE android_automation.suite_runs
    ADD COLUMN tags TEXT[] NOT NULL DEFAULT '{}';

CREATE INDEX runs_tags_gin       ON android_automation.runs       USING gin (tags);
CREATE INDEX suite_runs_tags_gin ON android_automation.suite_runs USING gin (tags);
