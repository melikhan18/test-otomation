...
import com.qaplatform.shared.auth.api.dto.AuthDtos;
import com.qaplatform.shared.auth.service.AuthService;
...
public class AuthController {
    ...
    public AuthDtos.CurrentUserResponse updateMe(@AuthenticationPrincipal JwtPrincipal principal,
        ...
        if (principal == null || principal.userId() == null) {
            throw com.qaplatform.common.error.ApiException.unauthorized("missing identity");
        }
